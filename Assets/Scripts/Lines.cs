...
public class Lines : MonoBehaviour {
	/// <summary>how to draw the line. Ideally using white and a 
	/// Self-Illumin/Diffuse shader.</summary>
	...
	public static Lines GetGlobal() {
		if(instance == null) {
			...
			if(instance == null) {
				Debug.LogWarning("no Lines global exists. creating...");
				GameObject go = new GameObject();
				instance = go.AddComponent<Lines>();
	...
	public static LineRenderer MakeCircle(ref GameObject lineObject, Color color,
	                                      ...
	                                      float linesize) {
		Vector3 r = Vector3.Cross(normal, Vector3.up).normalized;
